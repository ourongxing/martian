...
export function code(text: RichText[], lang: supportedCodeLang = "plain text"): Block {
  return {
    object: "block",
    type: "code",
    code: {
...
export function blockquote(text: RichText[] = [], children: Block[] = []): Block {
  return {
    object: "block",
    type: "quote",
    quote: {
...
export function bulletedListItem(text: RichText[], children: BlockWithoutChildren[] = []): Block {
  return {
    object: "block",
...
export function numberedListItem(text: RichText[], children: BlockWithoutChildren[] = []): Block {
  return {
    object: "block",
...
export function table(children: BlockWithoutChildren[], tableWidth: number): Block {
  return {
    object: "block",
    type: "table",
    table: {
